...
const MOCK_DATA = {
  1: {
    ...
    discountRules: "Applicable on family floater plans only",
    offerType: "Percent",
    offerValue: "10",
    channels: ["SMS", "Email"],
    messageTemplate:
      "Hi {customer_name}, enjoy 10% off on Star Health this summer!",
    whatsappTemplateId: "",
    clickTracking: true,
  ...
  2: {
    ...
    messageTemplate:
      "Dear Agent, earn extra commission this quarter. Call for details.",
