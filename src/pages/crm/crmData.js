...
export const INITIAL_LEADS = [
  ...
  { id:16, campaignId:5,  customerId:null, name:'Amit Shah',       mobile:'9811223344', enrollmentStatus:'Pending',   enrollmentDate:'',           purchaseStatus:'Pending',        purchaseDate:'',           claimedBy:2,    salesAssignedTo:null, calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:17, campaignId:5,  customerId:null, name:'Rekha Patil',     mobile:'9822334455', enrollmentStatus:'Enrolled',  enrollmentDate:'05/02/2025', purchaseStatus:'Interested',     purchaseDate:'',           claimedBy:2,    salesAssignedTo:null, calls: CALLS_INTERESTED },
  { id:18, campaignId:5,  customerId:null, name:'Deepak Mehta',    mobile:'9833445566', enrollmentStatus:'Pending',   enrollmentDate:'',           purchaseStatus:'Pending',        purchaseDate:'',           claimedBy:null, salesAssignedTo:null, calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:19, campaignId:5,  customerId:null, name:'Sunita Jain',     mobile:'9844556677', enrollmentStatus:'Enrolled',  enrollmentDate:'10/02/2025', purchaseStatus:'Not Interested', purchaseDate:'',           claimedBy:2,    salesAssignedTo:null, calls: CALLS_NOT_INTERESTED },
  { id:20, campaignId:5,  customerId:null, name:'Manoj Tiwari',    mobile:'9855667788', enrollmentStatus:'Pending',   enrollmentDate:'',           purchaseStatus:'Pending',        purchaseDate:'',           claimedBy:null, salesAssignedTo:null, calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:21, campaignId:5,  customerId:null, name:'Geeta Sharma',    mobile:'9866778899', enrollmentStatus:'Pending',   enrollmentDate:'',           purchaseStatus:'Pending',        purchaseDate:'',           claimedBy:null, salesAssignedTo:null, calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:22, campaignId:5,  customerId:null, name:'Rajesh Bose',     mobile:'9877889900', enrollmentStatus:'Pending',   enrollmentDate:'',           purchaseStatus:'Pending',        purchaseDate:'',           claimedBy:null, salesAssignedTo:null, calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:23, campaignId:5,  customerId:null, name:'Nisha Kulkarni',  mobile:'9888990011', enrollmentStatus:'Pending',   enrollmentDate:'',           purchaseStatus:'Pending',        purchaseDate:'',           claimedBy:null, salesAssignedTo:null, calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:24, campaignId:5,  customerId:null, name:'Farhan Shaikh',   mobile:'9800334455', enrollmentStatus:'Pending',   enrollmentDate:'',           purchaseStatus:'Pending',        purchaseDate:'',           claimedBy:null, salesAssignedTo:null, calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:25, campaignId:5,  customerId:null, name:'Lalitha Reddy',   mobile:'9811445566', enrollmentStatus:'Pending',   enrollmentDate:'',           purchaseStatus:'Pending',        purchaseDate:'',           claimedBy:null, salesAssignedTo:null, calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:26, campaignId:5,  customerId:null, name:'Vivek Pandey',    mobile:'9822556677', enrollmentStatus:'Pending',   enrollmentDate:'',           purchaseStatus:'Pending',        purchaseDate:'',           claimedBy:null, salesAssignedTo:null, calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:27, campaignId:5,  customerId:null, name:'Harish Malhotra', mobile:'9833001122', enrollmentStatus:'Enrolled',  enrollmentDate:'02/02/2025', purchaseStatus:'Interested',     purchaseDate:'',           claimedBy:2,    salesAssignedTo:1,    calls: CALLS_INTERESTED },
  { id:28, campaignId:5,  customerId:null, name:'Sonal Kapoor',    mobile:'9844112233', enrollmentStatus:'Enrolled',  enrollmentDate:'03/02/2025', purchaseStatus:'Purchased',      purchaseDate:'14/02/2025', claimedBy:2,    salesAssignedTo:1,    calls: CALLS_PURCHASED },
  { id:29, campaignId:5,  customerId:null, name:'Prakash Rao',     mobile:'9855223344', enrollmentStatus:'Enrolled',  enrollmentDate:'04/02/2025', purchaseStatus:'Interested',     purchaseDate:'',           claimedBy:2,    salesAssignedTo:1,    calls: CALLS_INTERESTED },
  { id:30, campaignId:5,  customerId:null, name:'Anita Verma',     mobile:'9866334455', enrollmentStatus:'Enrolled',  enrollmentDate:'05/02/2025', purchaseStatus:'Purchased',      purchaseDate:'16/02/2025', claimedBy:2,    salesAssignedTo:1,    calls: CALLS_PURCHASED },
  { id:31, campaignId:5,  customerId:null, name:'Sunil Bhatia',    mobile:'9877445566', enrollmentStatus:'Enrolled',  enrollmentDate:'06/02/2025', purchaseStatus:'Interested',     purchaseDate:'',           claimedBy:2,    salesAssignedTo:1,    calls: CALLS_INTERESTED },
  { id:32, campaignId:5,  customerId:null, name:'Kavya Menon',     mobile:'9888556677', enrollmentStatus:'Enrolled',  enrollmentDate:'07/02/2025', purchaseStatus:'Purchased',      purchaseDate:'18/02/2025', claimedBy:2,    salesAssignedTo:1,    calls: CALLS_PURCHASED },
  { id:33, campaignId:5,  customerId:null, name:'Dinesh Shetty',   mobile:'9899667788', enrollmentStatus:'Enrolled',  enrollmentDate:'08/02/2025', purchaseStatus:'Interested',     purchaseDate:'',           claimedBy:2,    salesAssignedTo:1,    calls: CALLS_INTERESTED },
  { id:34, campaignId:5,  customerId:null, name:'Poornima Das',    mobile:'9800778899', enrollmentStatus:'Enrolled',  enrollmentDate:'09/02/2025', purchaseStatus:'Purchased',      purchaseDate:'20/02/2025', claimedBy:2,    salesAssignedTo:1,    calls: CALLS_PURCHASED },
  { id:35, campaignId:5,  customerId:null, name:'Arjun Pillai',    mobile:'9811889900', enrollmentStatus:'Enrolled',  enrollmentDate:'10/02/2025', purchaseStatus:'Interested',     purchaseDate:'',           claimedBy:2,    salesAssignedTo:1,    calls: CALLS_INTERESTED },
  { id:36, campaignId:5,  customerId:null, name:'Meena Saxena',    mobile:'9822990011', enrollmentStatus:'Enrolled',  enrollmentDate:'11/02/2025', purchaseStatus:'Purchased',      purchaseDate:'22/02/2025', claimedBy:2,    salesAssignedTo:1,    calls: CALLS_PURCHASED },
