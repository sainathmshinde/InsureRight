...
export const INITIAL_LEADS = [
  ...
  { id:6,  campaignId:2, customerId:3,    name:'Divya Nair',     mobile:'9911223344', enrollmentStatus:'Enrolled',  enrollmentDate:'01/05/2025', purchaseStatus:'Purchased',      purchaseDate:'08/05/2025', claimedBy:null, salesAssignedTo:1,    calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:7,  campaignId:2, customerId:8,    name:'Arjun Singh',    mobile:'9922334455', enrollmentStatus:'Enrolled',  enrollmentDate:'02/05/2025', purchaseStatus:'Interested',     purchaseDate:'',           claimedBy:null, salesAssignedTo:1,    calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:8,  campaignId:2, customerId:null, name:'Meera Joshi',    mobile:'9933445566', enrollmentStatus:'Pending',   enrollmentDate:'',           purchaseStatus:'Pending',        purchaseDate:'',           claimedBy:null, salesAssignedTo:null, calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:9,  campaignId:2, customerId:6,    name:'Vikram Rao',     mobile:'9944556677', enrollmentStatus:'Enrolled',  enrollmentDate:'03/05/2025', purchaseStatus:'Purchased',      purchaseDate:'10/05/2025', claimedBy:null, salesAssignedTo:1,    calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:10, campaignId:2, customerId:null, name:'Anjali Desai',   mobile:'9955667788', enrollmentStatus:'Enrolled',  enrollmentDate:'04/05/2025', purchaseStatus:'Not Interested', purchaseDate:'',           claimedBy:null, salesAssignedTo:null, calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:11, campaignId:3, customerId:10,   name:'Rahul Gupta',    mobile:'9966778899', enrollmentStatus:'Enrolled',  enrollmentDate:'15/03/2025', purchaseStatus:'Purchased',      purchaseDate:'22/03/2025', claimedBy:2,    salesAssignedTo:1,    calls: CALLS_PURCHASED },
  { id:12, campaignId:3, customerId:null, name:'Pooja Reddy',    mobile:'9977889900', enrollmentStatus:'Pending',   enrollmentDate:'',           purchaseStatus:'Pending',        purchaseDate:'',           claimedBy:null, salesAssignedTo:null, calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:13, campaignId:4, customerId:5,    name:'Suresh Kumar',   mobile:'9988001122', enrollmentStatus:'Enrolled',  enrollmentDate:'20/04/2025', purchaseStatus:'Interested',     purchaseDate:'',           claimedBy:null, salesAssignedTo:1,    calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:14, campaignId:4, customerId:7,    name:'Kavita Pillai',  mobile:'9899112233', enrollmentStatus:'Enrolled',  enrollmentDate:'21/04/2025', purchaseStatus:'Purchased',      purchaseDate:'28/04/2025', claimedBy:null, salesAssignedTo:1,    calls: EMPTY_CALLS.map(c=>({...c})) },
  { id:15, campaignId:4, customerId:null, name:'Nikhil Bansal',  mobile:'9800223344', enrollmentStatus:'Pending',   enrollmentDate:'',           purchaseStatus:'Pending',        purchaseDate:'',           claimedBy:null, salesAssignedTo:null, calls: EMPTY_CALLS.map(c=>({...c})) },
]
