...
═══════════════════════════════════════════════════════ */
const BROKER_QUICK = [
  { label: "Add Employee", path: "/agent/create", icon: "👤", color: "#7c3aed" },
  {
    label: "Add Member",
    path: "/member/create",
    icon: "🧑",
...
const BROKER_ACTIVITY = [
  { time: "2 hrs ago", icon: "👤", text: "Employee Ravi Kulkarni onboarded" },
      ...
      <div style={S.banner}>
        <div>
          ...
          <div style={S.irdaiTxt}>
            IRDAI Reg. {user?.irdaiNo} · {user?.city}, {user?.state}
          </div>
        </div>
...
function AgentDashboard({ user }) {
  ...
  const myPendingPay = myPolicies.filter(
  ...
  const agentStats = [
    ...
    },
    {
      ...
      value: myActivePolicies,
      sub: `${myPendingPay} pending payment`,
    ...
    <div style={S.page}>
      <div style={{ ...S.banner, background: "var(--grad-purple)" }}>
        <div>
          ...
          <div style={S.companytxt}>Employee · {user?.company}</div>
          <div style={S.irdaiTxt}>
        ...
        {agentStats.map((s) => (
          ...
          >
            ...
            >
              <div>
                <div
                  style={{ ...S.statLabel, color: "rgba(255,255,255,0.92)" }}
                >
                  {s.label}
                </div>
                <div
            ...
            <div style={{ ...S.statSub, color: "rgba(255,255,255,0.86)" }}>
              {s.sub}
            </div>
          </div>
        ))}
...
const POLICY_ADS = [
  ...
  },
  {
    ...
    bullets: [
      "100% online · No medical visit",
      "Tax benefit u/s 80C",
      "Claim payout in 7 days",
    ],
    cta: "Explore",
  ...
  const custStats = [
    {
      ...
      value: activePols.length,
      sub: `${myPolicies.length} total`,
      gradient: "var(--grad-purple)",
      icon: "📋",
    },
    {
      ...
      value:
        totalCoverage >= 100000
          ? `₹${(totalCoverage / 100000).toFixed(0)}L`
          : totalCoverage
            ? `₹${totalCoverage}`
            : "₹0",
  ...
  return (
    <div style={S.page}>
      ...
      <div
        style={{
          background:
            "linear-gradient(120deg,#059669 0%,#047857 60%,#065f46 100%)",
          borderRadius: 16,
          padding: "28px 32px",
          display: "flex",
          justifyContent: "space-between",
      ...
      >
        <div>
          ...
          <div style={{ fontSize: 13, color: "#a7f3d0", marginBottom: 18 }}>
            Your insurance is managed by K.M. Dastur & Co. · IRDAI Reg
            CB-456/2008
          </div>
      ...
      <div>
        ...
        >
          {POLICY_ADS.map((ad) => (
            ...
            >
              <div
                style={{ background: ad.gradient, padding: "18px 20px 20px" }}
              >
                <div
                  style={{
                    display: "flex",
                ...
                >
                  {ad.bullets.map((b) => (
                    ...
                    >
                      <span
                        style={{ fontSize: 10, color: "rgba(255,255,255,.88)" }}
                      >
                        ✓
                      </span>{" "}
                      {b}
                ...
                >
                  <div>
                    ...
                    <div
                      style={{ fontSize: 10.5, color: "rgba(255,255,255,.82)" }}
                    >
                      {ad.statLabel}
                    </div>
                  </div>
      ...
      >
        ...
        <div style={S.card}>
          ...
          >
            ...
            <button style={S.linkBtn} onClick={() => navigate("/policy")}>
              View all →
            </button>
          </div>
          {myPolicies.length === 0 ? (
            ...
            myPolicies.map((p, i) => {
              ...
              return (
                <div
                  key={i}
                  style={{
                    border: `1px solid ${urgent ? "#fde68a" : "#f0edf8"}`,
                    borderRadius: 11,
                    padding: "14px 16px",
                    marginBottom: 10,
                    background: urgent ? "#fffbeb" : "#faf9fc",
                  }}
                >
                  <div
                    style={{
                  ...
                  {urgent && (
                    ...
                    >
                      ...
                      >
                        ⚠️ Expires in {days} days — renew to stay covered
                      </span>
                      <button
                        onClick={() => navigate("/policy/buy")}
                        style={{
              ...
              {[
                {
                  ...
                  done: activePols.some(
                    (p) =>
                      p.type === "Health" ||
                      p.product?.toLowerCase().includes("health"),
                  ),
                  color: "#059669",
                },
                { label: "Life Cover", done: false, color: "#7c3aed" },
                {
                  label: "Motor Insurance",
                    ...
                    (p) =>
                      p.type === "Motor" ||
                      p.product?.toLowerCase().includes("motor"),
                  ),
                  color: "#0891b2",
                },
                ...
                >
                  <span
                    style={{
                      ...
                      height: 20,
                      borderRadius: "50%",
                      background: done ? color + "18" : "#f5f3ff",
                      color: done ? color : "#d1d5db",
                      display: "flex",
                      alignItems: "center",
            ...
            >
              ...
              <div
                style={{
                  fontSize: 18,
                  fontWeight: 800,
                  color: completion >= 80 ? "#059669" : "#d97706",
                }}
              >
                {completion}%
              </div>
            ...
            <div style={S.progressTrack}>
              <div
                style={{
                  ...S.progressBar,
                  width: `${completion}%`,
                  background: completion >= 80 ? "#059669" : "#d97706",
                }}
              />
            </div>
            <div
        ...
        >
          {CLAIM_STEPS.map((step, i) => (
            ...
            >
              ...
              <div>
                <div
                  style={{ fontSize: 10.5, color: "#64748b", marginBottom: 2 }}
                >
                  Step {step.step}
                </div>
                <div
