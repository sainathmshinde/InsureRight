...
const _EXTRA_POL = Array.from({length:131},(_,i)=>{
  ...
  return { id, agentId:id%2===0?'a2':'a1', customerId:`c${(id%80)+1}`, proposalId:`PRO-2025-${1081+i}`, customerName:_PC[id%_PC.length], mobile:`9870${String(id).padStart(6,'0')}`, product, icName, type, premium, sumInsured:'₹3L', policyNo:`POL/2025/${String(id).padStart(4,'0')}`, paymentStatus: 'Payment received (completed)', status:'Active', startDate:`2025-${m}-${dd}`, endDate:`2026-${m}-${dd}`, campaignId:campId, campaignName:campName, paymentMode:id%2===0?'Online':'Offline', paymentType:['UPI','Gateway','NEFT','Cheque'][id%4] }
})

const MOCK = [
  { id: 1,  agentId: 'a1', customerId: 'c1', proposalId: 'PRO-2025-1001', customerName: 'Aarav Sharma',  mobile: '98765 43210', product: 'Group Health Insurance Policy for BPP_2026-2027', icName: 'SBI General Insurance',      type: 'Age Band Premium', premium: 27777, sumInsured: '₹3L',  policyNo: 'SBI/2025/001234', paymentStatus: 'Payment received (completed)',    status: 'Active',    startDate: '2025-01-15', endDate: '2026-01-14', campaignId: 11, campaignName: 'BPP Campaign_2026-2027',               paymentMode: 'Online',  paymentType: 'Gateway' },
  ...
  { id: 3,  agentId: 'a1', customerId: 'c3', proposalId: 'PRO-2025-1003', customerName: 'Amit Kumar',    mobile: '76543 21098', product: 'SBI Base Policy',                                icName: 'SBI General Insurance',      type: 'Base Policy',      premium: 31053, sumInsured: '₹5L',  policyNo: 'SBI/2025/003789', paymentStatus: 'Payment received (completed)',    status: 'Active',    startDate: '2025-02-10', endDate: '2026-02-09', campaignId: 8,  campaignName: 'SBI_STP_Campaign',                     paymentMode: 'Offline', paymentType: 'NEFT'    },
  ...
  { id: 15, agentId: 'a1', customerId: 'c16', proposalId: 'PRO-2025-1015', customerName: 'Sanjay Reddy',    mobile: '98712 34504', product: 'OPD Group Insurance Policy',                     icName: 'HDFC ERGO General Insurance',type: 'OPD',              premium: 14800, sumInsured: '₹25K', policyNo: 'HDF/2025/015303', paymentStatus: 'Payment received (completed)',     status: 'Active',    startDate: '2025-03-15', endDate: '2026-03-14', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Offline', paymentType: 'Cheque'  },
  ...
  { id: 18, agentId: 'a1', customerId: 'c19', proposalId: 'PRO-2025-1018', customerName: 'Shreya Agarwal',  mobile: '98712 34507', product: 'OUT-PATIENT CARE INSURANCE POLICY',              icName: 'Go Digit General Insurance', type: 'OPD',              premium: 10200, sumInsured: '₹15K', policyNo: 'DIG/2025/018505', paymentStatus: 'Payment received (completed)',     status: 'Active',    startDate: '2025-05-01', endDate: '2026-04-30', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Online',  paymentType: 'Gateway' },
  ...
  { id: 26, agentId: 'a2', customerId: 'c27', proposalId: 'PRO-2025-1026', customerName: 'Sunil Mehta',     mobile: '98712 34515', product: 'OPD Policy-2025-26',                             icName: 'SBI General Insurance',      type: 'OPD',              premium: 9900,  sumInsured: '₹25K', policyNo: 'SBI/2025/026010', paymentStatus: 'Payment received (completed)',     status: 'Active',    startDate: '2025-04-22', endDate: '2026-04-21', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Online',  paymentType: 'UPI'     },
  ...
  { id: 31, agentId: 'a1', customerId: 'c32', proposalId: 'PRO-2025-1031', customerName: 'Nandini Gupta',   mobile: '98712 34520', product: 'OUT-PATIENT CARE INSURANCE POLICY',              icName: 'Go Digit General Insurance', type: 'OPD',              premium: 10900, sumInsured: '₹15K', policyNo: 'DIG/2025/031313', paymentStatus: 'Payment received (completed)',     status: 'Active',    startDate: '2025-05-15', endDate: '2026-05-14', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Online',  paymentType: 'UPI'     },
  ...
  { id: 34, agentId: 'a1', customerId: 'c35', proposalId: 'PRO-2025-1034', customerName: 'Sneha Iyer',      mobile: '98712 34523', product: 'OPD Group Insurance Policy',                     icName: 'HDFC ERGO General Insurance', type: 'OPD',         premium: 11500, sumInsured: '₹25K', policyNo: 'HDF/2025/034202', paymentStatus: 'Payment received (completed)',     status: 'Active',    startDate: '2025-05-20', endDate: '2026-05-19', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Offline', paymentType: 'Cheque'  },
  ...
  { id: 39, agentId: 'a1', customerId: 'c40', proposalId: 'PRO-2025-1039', customerName: 'Sudarshan Pillai',mobile: '98712 34528', product: 'OUT-PATIENT CARE INSURANCE POLICY',              icName: 'Go Digit General Insurance',  type: 'OPD',         premium: 12400, sumInsured: '₹15K', policyNo: 'DIG/2025/039505', paymentStatus: 'Payment received (completed)',     status: 'Active',    startDate: '2025-03-30', endDate: '2026-03-29', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Online',  paymentType: 'Gateway' },
  ...
  { id: 46, agentId: 'a1', customerId: 'c47', proposalId: 'PRO-2025-1046', customerName: 'Rekha Saxena',    mobile: '98712 34535', product: 'OPD Group Insurance Policy',                     icName: 'HDFC ERGO General Insurance', type: 'OPD',         premium: 8200,  sumInsured: '₹25K', policyNo: 'HDF/2025/046909', paymentStatus: 'Payment received (completed)',     status: 'Active',    startDate: '2025-03-22', endDate: '2026-03-21', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Offline', paymentType: 'UPI'     },
  ...
  { id: 51, agentId: 'a2', customerId: 'c52', proposalId: 'PRO-2025-1051', customerName: 'Nikhil Sharma',   mobile: '98712 34540', product: 'OUT-PATIENT CARE INSURANCE POLICY',              icName: 'Go Digit General Insurance',  type: 'OPD',         premium: 12800, sumInsured: '₹15K', policyNo: 'DIG/2025/051212', paymentStatus: 'Payment received (completed)',     status: 'Active',    startDate: '2025-05-19', endDate: '2026-05-18', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Online',  paymentType: 'Gateway' },
  ...
  // Offline + NEFT + Paid
  { id: 62, agentId: 'a1', customerId: 'c63', proposalId: 'PRO-2025-1062', customerName: 'Hemant Kulkarni',  mobile: '98712 34551', product: 'OPD Policy-2025-26',                             icName: 'SBI General Insurance',       type: 'OPD',         premium: 9100,  sumInsured: '₹20K', policyNo: 'SBI/2025/062101', paymentStatus: 'Payment received (completed)', status: 'Active', startDate: '2025-02-10', endDate: '2026-02-09', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Offline', paymentType: 'NEFT' },
  { id: 63, agentId: 'a2', customerId: 'c64', proposalId: 'PRO-2025-1063', customerName: 'Roshni Pillai',   mobile: '98712 34552', product: 'OUT-PATIENT CARE INSURANCE POLICY',              icName: 'Go Digit General Insurance',  type: 'OPD',         premium: 11400, sumInsured: '₹15K', policyNo: 'DIG/2025/063202', paymentStatus: 'Payment received (completed)', status: 'Active', startDate: '2025-02-18', endDate: '2026-02-17', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Offline', paymentType: 'NEFT' },
  ...
  { id: 66, agentId: 'a1', customerId: 'c67', proposalId: 'PRO-2025-1066', customerName: 'Ganesh Nair',     mobile: '98712 34555', product: 'OPD Policy-2025-26',                             icName: 'SBI General Insurance',       type: 'OPD',         premium: 10800, sumInsured: '₹20K', policyNo: 'SBI/2025/066505', paymentStatus: 'Payment received (completed)', status: 'Active', startDate: '2025-03-25', endDate: '2026-03-24', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Offline', paymentType: 'NEFT' },
  { id: 67, agentId: 'a2', customerId: 'c68', proposalId: 'PRO-2025-1067', customerName: 'Preethi Iyer',    mobile: '98712 34556', product: 'OUT-PATIENT CARE INSURANCE POLICY',              icName: 'Go Digit General Insurance',  type: 'OPD',         premium: 12700, sumInsured: '₹15K', policyNo: 'DIG/2025/067606', paymentStatus: 'Payment received (completed)', status: 'Active', startDate: '2025-04-03', endDate: '2026-04-02', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Offline', paymentType: 'NEFT' },
  ...
  { id: 69, agentId: 'a2', customerId: 'c70', proposalId: 'PRO-2025-1069', customerName: 'Kavitha Rao',     mobile: '98712 34558', product: 'OPD Group Insurance Policy',                     icName: 'HDFC ERGO General Insurance', type: 'OPD',         premium: 9500,  sumInsured: '₹25K', policyNo: 'HDF/2025/069808', paymentStatus: 'Payment received (completed)', status: 'Active', startDate: '2025-04-20', endDate: '2026-04-19', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Offline', paymentType: 'NEFT' },
  ...
  { id: 71, agentId: 'a2', customerId: 'c72', proposalId: 'PRO-2025-1071', customerName: 'Shobha Pandey',   mobile: '98712 34560', product: 'OUT-PATIENT CARE INSURANCE POLICY',              icName: 'Go Digit General Insurance',  type: 'OPD',         premium: 11600, sumInsured: '₹15K', policyNo: 'DIG/2025/071010', paymentStatus: 'Payment received (completed)', status: 'Active', startDate: '2025-05-08', endDate: '2026-05-07', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Offline', paymentType: 'NEFT' },
  ...
  { id: 73, agentId: 'a2', customerId: 'c74', proposalId: 'PRO-2025-1073', customerName: 'Ashok Gupta',     mobile: '98712 34562', product: 'OPD Group Insurance Policy',                     icName: 'HDFC ERGO General Insurance', type: 'OPD',         premium: 10200, sumInsured: '₹25K', policyNo: 'HDF/2025/073212', paymentStatus: 'Payment received (completed)', status: 'Active', startDate: '2025-02-20', endDate: '2026-02-19', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Offline', paymentType: 'Cheque' },
  ...
  { id: 75, agentId: 'a2', customerId: 'c76', proposalId: 'PRO-2025-1075', customerName: 'Ravi Nambiar',    mobile: '98712 34564', product: 'OUT-PATIENT CARE INSURANCE POLICY',              icName: 'Go Digit General Insurance',  type: 'OPD',         premium: 11900, sumInsured: '₹15K', policyNo: 'DIG/2025/075414', paymentStatus: 'Payment received (completed)', status: 'Active', startDate: '2025-03-15', endDate: '2026-03-14', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Offline', paymentType: 'Cheque' },
  ...
  { id: 77, agentId: 'a2', customerId: 'c78', proposalId: 'PRO-2025-1077', customerName: 'Balaraj Shetty',  mobile: '98712 34566', product: 'OPD Group Insurance Policy',                     icName: 'HDFC ERGO General Insurance', type: 'OPD',         premium: 8700,  sumInsured: '₹25K', policyNo: 'HDF/2025/077616', paymentStatus: 'Payment received (completed)', status: 'Active', startDate: '2025-04-06', endDate: '2026-04-05', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Offline', paymentType: 'Cheque' },
  ...
  { id: 81, agentId: 'a2', customerId: 'c82', proposalId: 'PRO-2025-1081', customerName: 'Vinayak Rao',     mobile: '98712 34570', product: 'OPD Group Insurance Policy',                     icName: 'HDFC ERGO General Insurance', type: 'OPD',         premium: 9800,  sumInsured: '₹25K', policyNo: 'HDF/2025/081020', paymentStatus: 'Payment received (completed)', status: 'Active', startDate: '2025-05-13', endDate: '2026-05-12', campaignId: 5, campaignName: 'Campaign OPD and DIGIT PAYMENT PROTECTION', paymentMode: 'Offline', paymentType: 'Cheque' },
  ..._EXTRA_POL,
]
